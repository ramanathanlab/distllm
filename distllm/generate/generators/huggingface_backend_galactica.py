...
class HuggingFaceGalacticaGeneratorConfig(BaseConfig):
    """Configuration for the HuggingFaceGenerator."""

    name: Literal['huggingface_galactica'] = 'huggingface_galactica'  # type: ignore[assignment]
...
class HuggingFaceGalacticaGenerator:
    """Language model generator using hugging face backend."""

    def __init__(self, config: HuggingFaceGalacticaGeneratorConfig) -> None:
